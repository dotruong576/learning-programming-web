...
import { UserSchema } from '../../types/schema/userSchemaTypes';

const userService = {
  createUser: async (req: UserSchema): Promise<TServiceResponseType<TGetUserDetailDataResponse | null>> => {
  ...
  getMe: async (user: TUserRole): Promise<TServiceResponseType<TGetUserDetailDataResponse | null>> => {
